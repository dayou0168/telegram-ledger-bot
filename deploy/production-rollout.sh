...
# v2.4.10 production rollout helper. The default action is read-only preflight.
...
backup_all() {
  ...
  discover_pg_tools
  umask 077
  local dir="$BACKUP_ROOT/v2.4.10-$(date +%Y%m%d-%H%M%S)"
