...
func (s *Store) ClaimNotificationByID(ctx context.Context, id int64, maxAttempts int, now time.Time) (NotificationOutbox, bool, error) {
	...
	RETURNING n.id,n.kind,n.dedupe_key,n.chat_id,n.text,n.parse_mode,n.disable_preview,
		n.reply_to_message_id,n.reply_markup_json,n.reference_kind,n.reference_id,n.priority,
