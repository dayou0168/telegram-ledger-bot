...
@media(max-width:900px){.top{align-items:flex-start;flex-direction:column}.row,.row.two,.group-operations,.member-grid,.permission-panels,.permission-panel form,.observer-editor{grid-template-columns:1fr}.group-operations{grid-template-areas:"create" "edit" "danger"}.group-operation-edit{min-height:0;border-left:0;border-top:1px solid #d7e1ec}.group-operation-desc{min-height:0}.watch-head{display:none}.watch-row{grid-template-columns:1fr}.reply-settings{max-height:calc(100vh - 230px)}.reply-row{grid-template-columns:minmax(0,1fr) auto}.reply-relation{grid-column:1/-1}.reply-row .btn{grid-column:1/-1;width:100%}.observer-editor .btn{width:100%}.observer-grants{max-height:calc(100vh - 270px)}.btn{width:100%}.table-tools{flex-wrap:nowrap}.table-tools input[type=search]{flex:1 1 0;width:0;min-width:0}.table-tools .btn{flex:0 0 auto;width:auto;min-width:68px}.cleanup-dialog-body{grid-template-columns:1fr}.cleanup-dialog-body .wide{grid-column:auto}.cleanup-dialog-actions .btn,.cleanup-time .btn{width:auto}.cleanup-cell{min-width:140px;max-width:190px}.cleanup-summary{max-width:125px}}
