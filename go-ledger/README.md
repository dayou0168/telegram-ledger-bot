# Telegram Ledger Bot Go Runtime v2.5.2

这是机器人 Go 版 v2.5.2 发布主线，目标是把同步、异步、队列、并发、缓存、数据库和共享链上监听从架构层面重新设计。当前已具备：

发布说明见 [../docs/releases/v2.5.2.md](../docs/releases/v2.5.2.md)。
